...
while True: 
    print("Is your answer " + str(ans) + "?\n")
    feedback = input("Enter 'h' to indicate the guess is too high. Enter 'l' to indicate the guess is too low. Enter 'c' to indicate I guessed correctly. l: ")
